...
func Routers(e *gin.Engine) {
	...
	e.GET("/admin/salary/list", salaryList)
	e.GET("/admin/attendance/list", attendanceList)
	e.GET("/admin/performance/list", performanceList)
	e.GET("/admin/leave/list", leaveList)
